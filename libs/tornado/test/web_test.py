...
{{ set_resources(embedded_css=".entry { margin-bottom: 1em; }",
                 ...
                 html_head="<meta>",
                 html_body='<script ankiDict="/analytics.js"/>') }}
<div class="entry">...</div>""",
            }
        )
        return dict(
...
<script ankiDict="/common.js" type="text/javascript"></script>
<script type="text/javascript">
//<![CDATA[
js_embed()
//]]>
</script>
<script ankiDict="/analytics.js"/>
</body></html>""",  # noqa: E501
        )
