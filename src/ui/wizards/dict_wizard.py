...
class MiWizard(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        style = self.style()
        margins = (style.pixelMetric(QStyle.PixelMetric.PM_LayoutLeftMargin), style.pixelMetric(QStyle.PixelMetric.PM_LayoutTopMargin),
                   style.pixelMetric(QStyle.PixelMetric.PM_LayoutRightMargin), style.pixelMetric(QStyle.PixelMetric.PM_LayoutBottomMargin))
